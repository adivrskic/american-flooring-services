...
const USMap = ({ states }) => {
  ...
  return (
    <div className="us-map">
      ...
      <div className="us-map__content">
        <div className="state-info-wrapper">
          <div className="state-info">
            {states[selectedState] ? (
              <>
                <h2>{states[selectedState]?.name || emptyText}</h2>
                <p>
                  {states[selectedState]?.squareFtFlooring.toLocaleString()}{" "}
                  sqft of flooring completed
                </p>
                <div className="info-grid">
                  <div className="info-box">
                    <h4>Years Worked</h4>
                    <p>{states[selectedState]?.yearsWorked}</p>
                  </div>
                  <div className="info-box">
                    <h4>Projects Completed</h4>
                    <p>{states[selectedState]?.projectsCompleted}</p>
                  </div>
                  <div className="info-box">
                    <h4>Commercial Projects</h4>
                    <p>{states[selectedState]?.commercialProjects}</p>
                  </div>
                  <div className="info-box">
                    <h4>Residential Projects</h4>
                    <p>{states[selectedState]?.residentialProjects}</p>
                  </div>
                </div>
              </>
            ) : (
        ...
        <div className="svg-map">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0,0 1000,589">
            <a
              href="#"
              id="MA"
              onClick={(e) => handleStateClick(e, "MA")}
              className={selectedState === "MA" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="MN"
              onClick={(e) => handleStateClick(e, "MN")}
              className={selectedState === "MN" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="MT"
              onClick={(e) => handleStateClick(e, "MT")}
              className={selectedState === "MT" ? "selected" : ""}
            >
              <title>Montana</title>
              <path
                data-id="MT"
            ...
            <a
              href="#"
              id="ND"
              onClick={(e) => handleStateClick(e, "ND")}
              className={selectedState === "ND" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="HI"
              onClick={(e) => handleStateClick(e, "HI")}
              className={selectedState === "HI" ? "selected" : ""}
            >
              <title>Hawaii</title>
              <path
                data-id="HI"
            ...
            <a
              ...
              className={selectedState === "ID" ? "selected" : ""}
            >
              <title>Idaho</title>
              <path
                data-id="ID"
            ...
            <a
              href="#"
              id="WA"
              onClick={(e) => handleStateClick(e, "WA")}
              className={selectedState === "WA" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="AZ"
              onClick={(e) => handleStateClick(e, "AZ")}
              className={selectedState === "AZ" ? "selected" : ""}
            >
              <title>Arizona</title>
              <path
                data-id="AZ"
            ...
            <a
              href="#"
              id="CA"
              onClick={(e) => handleStateClick(e, "CA")}
              className={selectedState === "CA" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="CO"
              onClick={(e) => handleStateClick(e, "CO")}
              className={selectedState === "CO" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="NV"
              onClick={(e) => handleStateClick(e, "NV")}
              className={selectedState === "NV" ? "selected" : ""}
            >
              <title>Nevada</title>
              <path
                data-id="NV"
            ...
            <a
              href="#"
              id="NM"
              onClick={(e) => handleStateClick(e, "NM")}
              className={selectedState === "NM" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="OR"
              onClick={(e) => handleStateClick(e, "OR")}
              className={selectedState === "OR" ? "selected" : ""}
            >
              <title>Oregon</title>
              <path
                data-id="OR"
            ...
            <a
              href="#"
              id="UT"
              onClick={(e) => handleStateClick(e, "UT")}
              className={selectedState === "UT" ? "selected" : ""}
            >
              <title>Utah</title>
              <path
                data-id="UT"
            ...
            <a
              href="#"
              id="WY"
              onClick={(e) => handleStateClick(e, "WY")}
              className={selectedState === "WY" ? "selected" : ""}
            >
              <title>Wyoming</title>
              <path
                data-id="WY"
            ...
            <a
              href="#"
              id="AR"
              onClick={(e) => handleStateClick(e, "AR")}
              className={selectedState === "AR" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="IA"
              onClick={(e) => handleStateClick(e, "IA")}
              className={selectedState === "IA" ? "selected" : ""}
            >
              <title>Iowa</title>
              <path
                data-id="IA"
            ...
            <a
              href="#"
              id="KS"
              onClick={(e) => handleStateClick(e, "KS")}
              className={selectedState === "KS" ? "selected" : ""}
            >
              <title>Kansas</title>
              <path
                data-id="KS"
            ...
            <a
              href="#"
              id="MO"
              onClick={(e) => handleStateClick(e, "MO")}
              className={selectedState === "MO" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="NE"
              onClick={(e) => handleStateClick(e, "NE")}
              className={selectedState === "NE" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="OK"
              onClick={(e) => handleStateClick(e, "OK")}
              className={selectedState === "OK" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="SD"
              onClick={(e) => handleStateClick(e, "SD")}
              className={selectedState === "SD" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="LA"
              onClick={(e) => handleStateClick(e, "LA")}
              className={selectedState === "LA" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="TX"
              onClick={(e) => handleStateClick(e, "TX")}
              className={selectedState === "TX" ? "selected" : ""}
            >
              <title>Texas</title>
              <path
                data-id="TX"
            ...
            <a
              href="#"
              id="CT"
              onClick={(e) => handleStateClick(e, "CT")}
              className={selectedState === "CT" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="NH"
              onClick={(e) => handleStateClick(e, "NH")}
              className={selectedState === "NH" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="RI"
              onClick={(e) => handleStateClick(e, "RI")}
              className={selectedState === "RI" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="VT"
              onClick={(e) => handleStateClick(e, "VT")}
              className={selectedState === "VT" ? "selected" : ""}
            >
              <title>Vermont</title>
              <path
                data-id="VT"
            ...
            <a
              href="#"
              id="AL"
              onClick={(e) => handleStateClick(e, "AL")}
              className={selectedState === "AL" ? "selected" : ""}
            >
              <title>Alabama</title>
              <path
                data-id="AL"
            ...
            <a
              href="#"
              id="FL"
              onClick={(e) => handleStateClick(e, "FL")}
              className={selectedState === "FL" ? "selected" : ""}
            >
              <title>Florida</title>
              <path
                data-id="FL"
            ...
            <a
              href="#"
              id="GA"
              onClick={(e) => handleStateClick(e, "GA")}
              className={selectedState === "GA" ? "selected" : ""}
            >
              <title>Georgia</title>
              <path
                data-id="GA"
            ...
            <a
              href="#"
              id="MS"
              onClick={(e) => handleStateClick(e, "MS")}
              className={selectedState === "MS" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="SC"
              onClick={(e) => handleStateClick(e, "SC")}
              className={selectedState === "SC" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="IL"
              onClick={(e) => handleStateClick(e, "IL")}
              className={selectedState === "IL" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="IN"
              onClick={(e) => handleStateClick(e, "IN")}
              className={selectedState === "IN" ? "selected" : ""}
            >
              <title>Indiana</title>
              <path
                data-id="IN"
            ...
            <a
              href="#"
              id="KY"
              onClick={(e) => handleStateClick(e, "KY")}
              className={selectedState === "KY" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="NC"
              onClick={(e) => handleStateClick(e, "NC")}
              className={selectedState === "NC" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="OH"
              onClick={(e) => handleStateClick(e, "OH")}
              className={selectedState === "OH" ? "selected" : ""}
            >
              <title>Ohio</title>
              <path
                data-id="OH"
            ...
            <a
              href="#"
              id="TN"
              onClick={(e) => handleStateClick(e, "TN")}
              className={selectedState === "TN" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="VA"
              onClick={(e) => handleStateClick(e, "VA")}
              className={selectedState === "VA" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="WI"
              onClick={(e) => handleStateClick(e, "WI")}
              className={selectedState === "WI" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="WV"
              onClick={(e) => handleStateClick(e, "WV")}
              className={selectedState === "WV" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="DE"
              onClick={(e) => handleStateClick(e, "DE")}
              className={selectedState === "DE" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="DC"
              onClick={(e) => handleStateClick(e, "DC")}
              className={selectedState === "DC" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="MD"
              onClick={(e) => handleStateClick(e, "MD")}
              className={selectedState === "MD" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="NJ"
              onClick={(e) => handleStateClick(e, "NJ")}
              className={selectedState === "NJ" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="NY"
              onClick={(e) => handleStateClick(e, "NY")}
              className={selectedState === "NY" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="PA"
              onClick={(e) => handleStateClick(e, "PA")}
              className={selectedState === "PA" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="ME"
              onClick={(e) => handleStateClick(e, "ME")}
              className={selectedState === "ME" ? "selected" : ""}
            >
              <title>Maine</title>
              <path
                data-id="ME"
            ...
            <a
              href="#"
              id="MI"
              onClick={(e) => handleStateClick(e, "MI")}
              className={selectedState === "MI" ? "selected" : ""}
            >
            ...
            <a
              href="#"
              id="AK"
              onClick={(e) => handleStateClick(e, "AK")}
              className={selectedState === "AK" ? "selected" : ""}
            >
              <title>Alaska</title>
              <path
                data-id="AK"
